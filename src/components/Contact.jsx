                    ...
                    <div className="space-y-8">
                        ...
                        <div className="pt-8 border-t border-gray-800 text-left">
                            ...
                            <div className="flex gap-4">
                                <a href={defaultConfig.github_url} target="_blank" rel="noopener noreferrer" aria-label="GitHub profile" className="contact-icon bg-gray-800 p-4 rounded-xl hover:bg-gray-700 transition-all hover:-translate-y-2 group shadow-xl">
                                ...
                                <a href={defaultConfig.linkedin_url} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn profile" className="contact-icon bg-gray-800 p-4 rounded-xl hover:bg-blue-600 transition-all hover:-translate-y-2 group shadow-xl">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    ...
                                    className="w-full bg-[#0a0e27]/50 border border-gray-700 rounded-xl px-4 py-3 outline-none focus:border-indigo-500 transition-colors placeholder:text-gray-400"
                                    required
                                />
                            </div>
                            <div className="space-y-2">
