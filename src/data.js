...
export const techStack = [
  ...
  {
    name: "Python",
    icon: '<svg viewBox="0 0 24 24"><defs><linearGradient id="pyBlue" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#387EB8"/><stop offset="1" stop-color="#366994"/></linearGradient><linearGradient id="pyYellow" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="#FFE052"/><stop offset="1" stop-color="#FFC331"/></linearGradient></defs><path fill="url(#pyBlue)" d="M11.914 0C5.82 0 6.2 2.656 6.2 2.656l.007 2.752h5.814v.826H3.9S0 4.74 0 10.89c0 6.151 3.404 5.933 3.404 5.933h2.03v-2.867s-.109-3.42 3.35-3.42h5.766s3.24.052 3.24-3.148V3.202S18.28 0 11.914 0zM8.708 1.85c.578 0 1.046.468 1.046 1.046s-.468 1.046-1.046 1.046-1.046-.468-1.046-1.046.468-1.046 1.046-1.046z"/><path fill="url(#pyYellow)" d="M12.087 24c6.092 0 5.712-2.656 5.712-2.656l-.007-2.752h-5.814v-.826h8.123s3.899.445 3.899-5.706c0-6.151-3.404-5.933-3.404-5.933h-2.03v2.867s.109 3.42-3.35 3.42H9.45s-3.24-.052-3.24 3.148v5.292S5.72 24 12.087 24zm3.206-1.85c-.578 0-1.046-.468-1.046-1.046s.468-1.046 1.046-1.046 1.046.468 1.046 1.046-.468 1.046-1.046 1.046z"/></svg>',
    color: "#3776AB",
  },
  {
    name: "Express.js",
